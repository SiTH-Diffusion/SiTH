...
from .layer import make_conv_layers, make_linear_layers, make_deconv_layers
...
class BodyRotationNet(nn.Module):
    def __init__(self, feat_dim = 768):
        ...
        self.body_pose_out = make_linear_layers(
            ...
            [self.joint_num * (512+3), 21 * 6], relu_final=False)  # without root
...
class FaceRegressor(nn.Module):
    def __init__(self, feat_dim=768):
        ...
        self.expr_out = make_linear_layers([feat_dim, 10], relu_final=False)
...
class HandRoI(nn.Module):
    ...
    def forward(self, img_feat, lhand_bbox, rhand_bbox):
        ...
        lhand_img_feat = roi_align(img_feat, lhand_bbox_roi, (cfg['output_hand_hm_shape'][1], cfg['output_hand_hm_shape'][2]), 1.0, 0, False)
        ...
        rhand_img_feat = roi_align(img_feat, rhand_bbox_roi, (cfg['output_hand_hm_shape'][1], cfg['output_hand_hm_shape'][2]), 1.0, 0, False)
